package com.example.myplayerlib;
...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            ...
            mDialogProgressBar = ((ProgressBar) localView.findViewById(com.example.myplayerlib.R.id.duration_progressbar));
            mDialogSeekTime = ((TextView) localView.findViewById(com.example.myplayerlib.R.id.tv_current));
            mDialogTotalTime = ((TextView) localView.findViewById(com.example.myplayerlib.R.id.tv_duration));
            mDialogIcon = ((ImageView) localView.findViewById(com.example.myplayerlib.R.id.duration_image_tip));
